<script>
    ...
    import GenerateRequirements from '../components/Runme/GenerateRequirements.svelte'
    ...
    const runmeSpecUrl = 'https://github.com/jexia-com/runme/blob/master/docs/specification.md'
    const generateSpecUrl = '/generate-spec'
