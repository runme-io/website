...
npm run start
        ...
        <h2>Step 5</h2>
        <p>Kubernetes cluster placed in DigitalOcean will pull this docker image and deploy it. Also, Kubernetes will create Let’s Encrypt SSL certificate for your application.</p>
